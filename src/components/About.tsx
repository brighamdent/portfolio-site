...
export const About = () => {
  ...
  return (
    ...
    >
      <h1 className="text-[32px] lg:text-[64px]">About</h1>
      <div className="flex flex-col lg:flex-row items-center justify-around w-[300px] lg:w-[900px] ">
        <img
          src={headshot}
          alt=""
          className="rounded-lg w-[300px] lg:w-[400px]"
        />
        <div className="flex flex-col items-center justify-around">
          <h2 className="w-[300px] text-[24px] lg:text-[32px]  lg:w-[500px] font-light text-left ml-10 ">
